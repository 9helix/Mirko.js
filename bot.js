...
client.on('interactionCreate', async interaction => {
    ...
    if (interaction.commandName === 'ping') {
        ...
        await axios.get("https://www.spaceweatherlive.com/includes/live-data.php?object=solar_flare&lang=EN", {
            headers: {
                Referer: 'https://www.spaceweatherlive.com/includes/live-data.php?object=solar_flare&lang=EN',
        ...
        await interaction.reply({
            embeds: [{
                ...
                description: "Current value: **" + data["val"].replace(">", "<").split("<")[2] + "**\n" +
                    "2h max: **" + data["val2"].replace(">", "<").split("<")[2] + "**\n" +
                    "24h max: **" + data["val24"].replace(">", "<").split("<")[2] + "**\n\n**Notice**\nA & B = Quiet\nC = Small flare\nM = Strong flare\nX = Major flare",
